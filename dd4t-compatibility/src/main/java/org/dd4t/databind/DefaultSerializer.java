...
public class DefaultSerializer implements DataBinder, org.dd4t.core.serializers.DD4T1Serializer {
    ...
    public Object deserialize(Object object, Class c) throws Exception {
        ...
        try {
            ...
            LOG.error("error deserializing to class " + c.getName() + " error occurred while deserializing node " +
                    currentNodeName, e);
            throw new RuntimeException("Error deserializing node " + currentNodeName + ", target class " + c.getName
                    (), e);
        }
    }
    ...
    @Override
    public <T extends Page> T buildPage(String source, Class<T> aClass) throws SerializationException {
    ...
    @Override
    public <T extends ComponentPresentation> T buildComponentPresentation(String source, Class<T>
    ...
    @Override
    public Map<String, BaseViewModel> buildModels(Object source, Set<String> modelNames, String templateUri) throws
    ...
    @Override
    public <T extends BaseViewModel> T buildModel(Object rawData, String modelName, String templateUri) throws
            SerializationException {
        // not supported for dd4t-1
        return null;
    }
    ...
    @Override
    public <T extends BaseViewModel> T buildModel(Object source, Class modelClass, String templateUri) throws
            SerializationException {
        // not supported for dd4t-1
        return null;
    }
    ...
    @Override
    public ComponentPresentation buildDynamicComponentPresentation(ComponentPresentation componentPresentation,
                                                                   Class<? extends Component> aClass) throws
            SerializationException {
        // not supported for dd4t-1
        return null;
    }
    ...
    @Override
    public <T extends Component> T buildComponent(Object source, Class<T> aClass) throws SerializationException {
        // not supported for dd4t-1
        return null;
    }
