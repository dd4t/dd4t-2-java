...
public class RichTextUtils {
    ...
    public static String resolveXhtmlBody(final String body, boolean resolveLinks, final LinkResolver linkResolver,
                                          final String contextPath) throws ItemNotFoundException,
     ...
     */
    public static void resolveXhtmlField(final XhtmlField xhtmlFields, final boolean resolveLinks, final LinkResolver
            linkResolver, final String contextPath) throws ItemNotFoundException, SerializationException {
